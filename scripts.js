...
let containerprodutos =document.querySelector(".productus-container");
    ...
    produtos.forEach(prd=>{
        ...
        <div class="product-card">
            ...
            <div class="product-info">
                <h3 class="product-name">${prd.descricao}</h3>
                <p class="product-description">Smartphone Apple com câmera avançada</p>
